...
def submit_registration():
    ...
    try:
        ...
        ''', (
            ...
            file_paths.get('formImage'), file_paths.get('formPdf'),
        ...
        if 'formImage' in file_paths and os.path.exists(file_paths['formImage']):
            ...
            print("formImage file not found or not saved.")

        if 'formPdf' in file_paths and os.path.exists(file_paths['formPdf']):
            ...
            print("formPdf file not found or not saved.")
